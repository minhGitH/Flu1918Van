...
# This is an example for LSE fitting method with phi = 0.0083, change variables 
...
baseline <- read_csv("LSE/Outputs/phi_0083/LSE_baseline_results_Nov9.csv") |> 
  arrange(rmse) |> 
  slice(1)
temp <- read_csv("LSE/Outputs/phi_0083/LSE_temp_results_Nov9.csv")|> 
  arrange(rmse) |> 
  slice(1)
npi <- read_csv("LSE/Outputs/phi_0083/LSE_npi_results_Nov9.csv") |> 
  arrange(rmse) |> 
  slice(1)
response <- read_csv("LSE/Outputs/phi_0083/LSE_response_results_Nov9.csv") |> 
  arrange(rmse) |> 
  slice(1)
no_npi <- read_csv("LSE/Outputs/phi_0083/LSE_no_npi_results_Nov9.csv") |> 
  arrange(rmse) |> 
  slice(1)
no_response <- read_csv("LSE/Outputs/phi_0083/LSE_no_response_results_Nov9.csv") |> 
  arrange(rmse) |> 
  slice(1)
no_temp <- read_csv("LSE/Outputs/phi_0083/LSE_no_temp_results_Nov9.csv") |> 
  arrange(rmse) |> 
  slice(1)
full <- read_csv("LSE/Outputs/phi_0083/LSE_full_results_Nov9.csv") |> 
  arrange(rmse) |> 
  slice(1)
...
# ggsave("LSE_results_phi_0083.png", final_plot,
